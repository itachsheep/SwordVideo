...
public class Divider extends RecyclerView.ItemDecoration {
    ...
    private boolean isNotDrawRight(View view, RecyclerView parent, int currentPosition, int spanCount, int adapterCount) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            return ((LinearLayoutManager) layoutManager).getOrientation() == LinearLayoutManager.VERTICAL || currentPosition == adapterCount - getFooterCount() - 1;
