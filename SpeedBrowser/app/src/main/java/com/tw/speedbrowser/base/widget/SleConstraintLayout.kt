 ...
 */
class SleConstraintLayout : ConstraintLayout {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        context.obtainStyledAttributes(attrs, R.styleable.SleConstraintLayout, defStyleAttr, 0)
            .apply {
                type = getInt(R.styleable.SleConstraintLayout_sle_type, TYPE_NONE)
                shape =
                    getInt(R.styleable.SleConstraintLayout_sle_shape, GradientDrawable.RECTANGLE)
                innerRadius =
                    getDimensionPixelSize(R.styleable.SleConstraintLayout_sle_innerRadius, 0)
                innerRadiusRatio =
                    getFloat(R.styleable.SleConstraintLayout_sle_innerRadiusRatio, 0f)
                thickness =
                    getDimensionPixelSize(R.styleable.SleConstraintLayout_sle_thickness, 0)
                thicknessRatio = getFloat(R.styleable.SleConstraintLayout_sle_thicknessRatio, 0f)
                normalBackgroundColor =
                    getColor(R.styleable.SleConstraintLayout_sle_normalBackgroundColor, 0)
                pressedBackgroundColor =
                    getColor(R.styleable.SleConstraintLayout_sle_pressedBackgroundColor, 0)
                disabledBackgroundColor =
                    getColor(
                        R.styleable.SleConstraintLayout_sle_disabledBackgroundColor,
                        DEFAULT_DISABLE_BACKGROUND_COLOR
                    )
                selectedBackgroundColor =
                    getColor(R.styleable.SleConstraintLayout_sle_selectedBackgroundColor, 0)
                strokeWidth =
                    getDimensionPixelSize(R.styleable.SleConstraintLayout_sle_strokeWidth, 0)
                dashWidth = getDimension(R.styleable.SleConstraintLayout_sle_dashWidth, 0f)
                dashGap = getDimension(R.styleable.SleConstraintLayout_sle_dashGap, 0f)
                normalStrokeColor =
                    getColor(R.styleable.SleConstraintLayout_sle_normalStrokeColor, 0)
                pressedStrokeColor =
                    getColor(
                        R.styleable.SleConstraintLayout_sle_pressedStrokeColor,
                        normalStrokeColor
                    )
                disabledStrokeColor =
                    getColor(
                        R.styleable.SleConstraintLayout_sle_disabledStrokeColor,
                        normalStrokeColor
                    )
                selectedStrokeColor =
                    getColor(
                        R.styleable.SleConstraintLayout_sle_selectedStrokeColor,
                        normalStrokeColor
                    )
                cornersRadius =
                    getDimension(R.styleable.SleConstraintLayout_sle_cornersRadius, 0f)
                cornersTopLeftRadius =
                    getDimension(R.styleable.SleConstraintLayout_sle_cornersTopLeftRadius, 0f)
                cornersTopRightRadius =
                    getDimension(R.styleable.SleConstraintLayout_sle_cornersTopRightRadius, 0f)
                cornersBottomLeftRadius =
                    getDimension(R.styleable.SleConstraintLayout_sle_cornersBottomLeftRadius, 0f)
                cornersBottomRightRadius =
                    getDimension(R.styleable.SleConstraintLayout_sle_cornersBottomRightRadius, 0f)
                val normalGradientColorsResourceId =
                    getResourceId(R.styleable.SleConstraintLayout_sle_normalGradientColors, 0)
                ...
                val pressedGradientColorsResourceId =
                    getResourceId(R.styleable.SleConstraintLayout_sle_pressedGradientColors, 0)
                ...
                val disabledGradientColorsResourceId =
                    getResourceId(R.styleable.SleConstraintLayout_sle_disabledGradientColors, 0)
                ...
                val selectedGradientColorsResourceId =
                    getResourceId(R.styleable.SleConstraintLayout_sle_selectedGradientColors, 0)
                ...
                gradientOrientation = getInt(
                    R.styleable.SleConstraintLayout_sle_gradientOrientation,
                    GRADIENT_ORIENTATION_TOP_BOTTOM
                )
                gradientType =
                    getInt(
                        R.styleable.SleConstraintLayout_sle_gradientType,
                        GradientDrawable.LINEAR_GRADIENT
                    )
                gradientCenterX =
                    getDimension(R.styleable.SleConstraintLayout_sle_gradientCenterX, 0f)
                gradientCenterY =
                    getDimension(R.styleable.SleConstraintLayout_sle_gradientCenterY, 0f)
                gradientRadius =
                    getDimension(R.styleable.SleConstraintLayout_sle_gradientRadius, 0f)
                ...
                interceptType =
                    getInt(
                        R.styleable.SleConstraintLayout_sle_interceptType,
                        INTERCEPT_TYPE_SUPER
                    )
                dispatchChildSelected =
                    getBoolean(R.styleable.SleConstraintLayout_sle_dispatch_child_selected, false)
                dispatchChildPressed =
                    getBoolean(R.styleable.SleConstraintLayout_sle_dispatch_child_pressed, false)
            }.recycle()
        init()
    }
