package com.tw.speedbrowser.base.widget.showdow;
...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_hl_cornerRadius, getResources().getDimension(R.dimen.len_0));
            ...
            mShadowColor = attr.getColor(R.styleable.ShadowLayout_hl_shadowColor, ResUtils.getColor(getContext(),R.color.color_transparent));
            ...
            //背景颜色的点击(默认颜色为白色)
            mBackGroundColor = ResUtils.getColor(getContext(),R.color.common_white);
