package com.tw.speedbrowser.base.ui.immersionbar;
...
import static com.tw.speedbrowser.base.ui.immersionbar.Constants.FLAG_FITS_DEFAULT;
import static com.tw.speedbrowser.base.ui.immersionbar.Constants.FLAG_FITS_STATUS;
import static com.tw.speedbrowser.base.ui.immersionbar.Constants.FLAG_FITS_SYSTEM_WINDOWS;
import static com.tw.speedbrowser.base.ui.immersionbar.Constants.FLAG_FITS_TITLE;
import static com.tw.speedbrowser.base.ui.immersionbar.Constants.FLAG_FITS_TITLE_MARGIN_TOP;
import static com.tw.speedbrowser.base.ui.immersionbar.Constants.IMMERSION_BOUNDARY_COLOR;
import static com.tw.speedbrowser.base.ui.immersionbar.Constants.IMMERSION_ID_NAVIGATION_BAR_VIEW;
import static com.tw.speedbrowser.base.ui.immersionbar.Constants.IMMERSION_ID_STATUS_BAR_VIEW;
import static com.tw.speedbrowser.base.ui.immersionbar.Constants.IMMERSION_MIUI_NAVIGATION_BAR_DARK;
import static com.tw.speedbrowser.base.ui.immersionbar.Constants.IMMERSION_MIUI_STATUS_BAR_DARK;
...
public final class ImmersionBar implements ImmersionCallback {
     ...
     * @param dialog   the dialog
     */
    public static void destroy(@NonNull Activity activity, Dialog dialog) {
    ...
    public ImmersionBar statusBarColor(@ColorRes int statusBarColor) {
        return this.statusBarColorInt(ResUtils.getColor(statusBarColor));
    }
    ...
    public ImmersionBar statusBarColor(@ColorRes int statusBarColor,
        ...
        return this.statusBarColorInt(ResUtils.getColor(statusBarColor), alpha);
    }
    ...
    public ImmersionBar statusBarColor(@ColorRes int statusBarColor,
                                       ...
                                       @FloatRange(from = 0f, to = 1f) float alpha) {
        return this.statusBarColorInt(ResUtils.getColor(statusBarColor),
                ResUtils.getColor(statusBarColorTransform),
                alpha);
    }
    ...
    public ImmersionBar navigationBarColor(@ColorRes int navigationBarColor) {
        return this.navigationBarColorInt(ResUtils.getColor(navigationBarColor));
    }
    ...
    public ImmersionBar navigationBarColor(@ColorRes int navigationBarColor,
        ...
        return this.navigationBarColorInt(ResUtils.getColor(navigationBarColor), navigationAlpha);
    }
    ...
    public ImmersionBar navigationBarColor(@ColorRes int navigationBarColor,
                                           ...
                                           @FloatRange(from = 0f, to = 1f) float navigationAlpha) {
        return this.navigationBarColorInt(ResUtils.getColor(navigationBarColor),
                ResUtils.getColor(navigationBarColorTransform), navigationAlpha);
    }
    ...
    public ImmersionBar barColor(@ColorRes int barColor) {
        return this.barColorInt(ResUtils.getColor(barColor));
    }
    ...
    public ImmersionBar barColor(@ColorRes int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
        return this.barColorInt(ResUtils.getColor(barColor), barColor);
    }
    ...
    public ImmersionBar barColor(@ColorRes int barColor,
        ...
        return this.barColorInt(ResUtils.getColor(barColor),
                ResUtils.getColor(barColorTransform), barAlpha);
    }
    ...
    public ImmersionBar statusBarColorTransform(@ColorRes int statusBarColorTransform) {
        return this.statusBarColorTransformInt(ResUtils.getColor(statusBarColorTransform));
    }
    ...
    public ImmersionBar navigationBarColorTransform(@ColorRes int navigationBarColorTransform) {
        return this.navigationBarColorTransformInt(ResUtils.getColor(navigationBarColorTransform));
    }
    ...
    public ImmersionBar barColorTransform(@ColorRes int barColorTransform) {
        return this.barColorTransformInt(ResUtils.getColor(barColorTransform));
    }
    ...
    public ImmersionBar addViewSupportTransformColor(View view, @ColorRes int viewColorAfterTransform) {
        return this.addViewSupportTransformColorInt(view, ResUtils.getColor(viewColorAfterTransform));
    }
    ...
    public ImmersionBar addViewSupportTransformColor(View view, @ColorRes int viewColorBeforeTransform,
        ...
        return this.addViewSupportTransformColorInt(view,
                ResUtils.getColor(viewColorBeforeTransform),
                ResUtils.getColor(viewColorAfterTransform));
    }
    ...
    public ImmersionBar flymeOSStatusBarFontColor(@ColorRes int flymeOSStatusBarFontColor) {
        mBarParams.flymeOSStatusBarFontColor = ResUtils.getColor(flymeOSStatusBarFontColor);
    ...
    public ImmersionBar fitsSystemWindows(boolean fits, @ColorRes int contentColor) {
        return fitsSystemWindowsInt(fits, ResUtils.getColor(contentColor));
    }
    ...
    public ImmersionBar fitsSystemWindows(boolean fits, @ColorRes int contentColor
        ...
        return fitsSystemWindowsInt(fits, ResUtils.getColor(contentColor),
                ResUtils.getColor(contentColorTransform), contentAlpha);
    }
