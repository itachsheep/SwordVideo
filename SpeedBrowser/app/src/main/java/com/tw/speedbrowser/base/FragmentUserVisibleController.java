...
public class FragmentUserVisibleController {
    ...
    public void resume() {
        ...
        if (fragment.getUserVisibleHint()) {
            userVisibleCallback.onVisibleToUserChanged(true);
    ...
    public void pause() {
        ...
        if (fragment.getUserVisibleHint()) {
            userVisibleCallback.onVisibleToUserChanged(false);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (fragment.isResumed()) {
            userVisibleCallback.onVisibleToUserChanged(isVisibleToUser);
            callbackListener(isVisibleToUser);
            if (DEBUG) {
                if (isVisibleToUser) {
    ...
    public interface UserVisibleCallback {
        ...
        void onVisibleToUserChanged(boolean isVisibleToUser);
    }
