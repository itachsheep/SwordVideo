package com.tao.camera.egl.render
...
import com.tao.camera.callback.IRenderer
import com.tao.camera.egl.ShaderHelper
 ...
 * </pre>
 */
public class ImageRenderer(context: Context) : IRenderer {
...
//        }
    ...
    override fun onDraw() {
        ...
        //7.绘制一张图片
        mImageTextureId = loadFile(mImagePath)
        //绑定 fbo
        GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, mFboID);
...
//        GLES20.glUniformMatrix4fv(umatrix, 1, false, mMatrix, 0);
        ...
        // 解绑 VBO
        GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0)
        val ids = intArrayOf(mImageTextureId)
    ...
    private fun loadFile(src: String?): Int {
        ...
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_LINEAR)
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR)
        var bitmap = BitmapFactory.decodeFile(src)
